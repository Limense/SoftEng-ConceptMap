<section class="px-[30px] w-full mx-auto box-border py-6">
    ...
    <div class="box-border">
        <div class="text-white py-4">
            <!-- Ajustar padding -->
            <x-button href="{{ url('/modulo-2') }}" bgColor="bg-green-primary" textColor="text-black"
        ...
        <div class="flex flex-row">
            @include('modulo-2.tema-08.sidebar')

            <!-- Lado derecho -->
            <div class="basis-[75%] max-w-[75%] relative w-full px-[15px]">
                @include('modulo-2.tema-08.unidad')

                @include('modulo-2.tema-08.evaluacion')
            </div>
        </div>
    </div>
</section>
