...
<div class="pt-[15px] px-[15px]">
    <div class="relative w-full px-[15px]">
        <p class="text-[24px] font-semibold mb-[1rem] text-white">Tema: </p>
        <p class="text-[18px] font-semibold mb-[1rem] text-white">ORIGEN, OBJETIVOS, FINALIDAD, PRINCIPIOS Y
            CARACTERÍSTICAS DE LA INGENIERÍA DE SOFTWARE</p>
        <div
            ...
            <div class="flex items-center space-x-[10px]">
                <div class="py-[1rem]">
                    <img src="{{ asset('images/files.png') }}" alt="Descripción de la imagen" class="h-[48px] w-auto">
                </div>
                <p class="text-[18px] font-normal text-white my-auto">Ficha de trabajo</p>
            </div>
            <div>
